          ...
          child: SingleChildScrollView(
            ...
            child: ConstrainedBox(
              ...
              child: Column(children: [
                ...
                Container(padding: const EdgeInsets.all(16), decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(14), border: Border.all(color: const Color(0xffd8eff1))), child: const Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text('รายละเอียดนัดหมาย', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: Color(0xff215b62))), SizedBox(height: 14), _AppointmentRow(icon: Icons.confirmation_number_outlined, title: 'หมายเลขคิว', value: '0001'), Divider(height: 19, color: Color(0xffe5f1f2)), _AppointmentRow(icon: Icons.calendar_month_outlined, title: 'วันนัดหมาย', value: '14 พฤษภาคม 2567'), Divider(height: 19, color: Color(0xffe5f1f2)), _AppointmentRow(icon: Icons.access_time_rounded, title: 'เวลา', value: '09:00 น.'), Divider(height: 19, color: Color(0xffe5f1f2)), _AppointmentRow(icon: Icons.location_on_outlined, title: 'สถานที่', value: 'Arm care Physical Therapy Clinic') ])),
